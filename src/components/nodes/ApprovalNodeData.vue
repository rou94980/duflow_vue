...
const target = reactive({
  type: flowStore.activeNodeContent.approvalTarget.type || "",
  operator: flowStore.activeNodeContent.approvalTarget.operator || "",
});
const deptOpts = ref([]);
const empOpts = ref([]);
...
const submit = () => {
  // 檢查
  flowStore.activeNodeContent.approvalTarget.type = target.type;
  flowStore.activeNodeContent.approvalTarget.operator = target.operator;
